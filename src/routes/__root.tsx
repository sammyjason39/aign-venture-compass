  ...
  head: () => ({
    meta: [
      ...
      { title: "AIGN Startup Curation System" },
      {
        name: "description",
        content:
          "Classify, score, and prioritize AI startups entering the AIGN ecosystem with a standard venture evaluation framework.",
      },
      { name: "author", content: "AIGN" },
      { property: "og:title", content: "AIGN Startup Curation System" },
      {
        property: "og:description",
        content:
          "A standard framework to classify, evaluate, and prioritize AI startups entering the AIGN ecosystem.",
      },
